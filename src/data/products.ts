...
const excelProducts: Product[] = [
  ...
  },
  {
    ...
    price: 52900,
    images: ["/products/placeholder.svg", "/products/placeholder.svg", "/products/placeholder.svg"],
    description: "Sensor de presión de aceite de alta precisión para motores diésel de vehículos pesados. Señal analógica confiable con conexión directa al tablero de instrumentos. Compatible con motores Mercedes-Benz serie 900.",
  ...
  },
  {
    ...
    price: 21200,
    images: ["/products/placeholder.svg", "/products/placeholder.svg", "/products/placeholder.svg"],
    description: "Formador de juntas anaeróbico Loctite 515 para sellado de superficies mecanizadas. Rellena irregularidades y forma una junta flexible y resistente a fluidos. Ideal para tapas de cárter, carcasas y bridas.",
  ...
  },
  {
    ...
    name: "Foco LED Claridad 12/24V Ámbar",
  ...
  },
  {
    ...
    name: "Foco LED Intermitente Delantero 70mm 12/24V Ámbar Braslux",
    category: "iluminacion",
    brand: "Braslux",
    price: 4212,
    images: ["/products/placeholder.svg", "/products/placeholder.svg", "/products/placeholder.svg"],
  ...
  },
  {
    ...
    name: "Foco LED Trasero 96mm 24V Intermitente Ámbar Braslux",
    category: "iluminacion",
    brand: "Braslux",
    price: 11990,
    images: ["/products/placeholder.svg", "/products/placeholder.svg", "/products/placeholder.svg"],
  ...
  },
  {
    ...
    name: "Foco LED Lateral Rectangular Ámbar Braslux",
    category: "iluminacion",
    brand: "Braslux",
    price: 4410,
  ...
  },
  {
    ...
    name: "Foco LED 125mm Trasero Dúo Ámbar/Rojo Braslux",
    category: "iluminacion",
    brand: "Braslux",
    price: 15770,
    images: ["/products/placeholder.svg", "/products/placeholder.svg", "/products/placeholder.svg"],
...
const catalogProducts: Product[] = [
  ...
  {
    code: "8097.70.301",
    name: "Foco Led Trasero 125mm Ámbar Direccional",
    category: "iluminacion",
    brand: "Recambio SpA",
    price: null,
    images: ["/products/placeholder.svg", "/products/placeholder.svg", "/products/placeholder.svg"],
  ...
  {
    code: "7071.50.301",
    name: "Foco Led Lateral Posición Reflector Ovalado Ámbar Caio-Euro6",
    category: "iluminacion",
    brand: "Recambio SpA",
    price: null,
    images: ["/products/placeholder.svg", "/products/placeholder.svg", "/products/placeholder.svg"],
  ...
  {
    code: "8976.10.301",
    name: "Foco Lateral Posición Reflectante Ámbar",
    category: "iluminacion",
    brand: "Recambio SpA",
    price: null,
    images: ["/products/placeholder.svg", "/products/placeholder.svg", "/products/placeholder.svg"],
  ...
  },
  {
    ...
    price: null,
    images: ["/products/placeholder.svg", "/products/placeholder.svg", "/products/placeholder.svg"],
    description: "Soquete universal de 1 polo con manguito protector de 300mm. Cable prolongado con terminal para instalación directa sin necesidad de empalmes adicionales.",
  ...
  {
    code: "001006",
    name: "Sensor Nivel Aceite Cárter 904-924-906-926",
    category: "generales",
    brand: "Recambio SpA",
    price: null,
    images: ["/products/placeholder.svg", "/products/placeholder.svg", "/products/placeholder.svg"],
    ...
    specs: { "Tipo": "Sensor capacitivo", "Compatibilidad": "OM-904/924/906/926", "Conector": "3 pines", "Señal": "Analógica", "Montaje": "Cárter motor", "Material": "Aluminio / Plástico técnico" },
    inStock: true,
  },
  {
    code: "AB17.4",
